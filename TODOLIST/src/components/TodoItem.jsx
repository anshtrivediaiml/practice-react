...
function TodoItem({todo}) {
  ...
  return (
    <div className={`flex border relative border-black/10 rounded-lg px-3 py-1.5 gap-x-3  shadow-xs shadow-white/50 duration-300 text-black ${todo.completed?'bg-[#c6e9a7]':'bg-[#ccbed7]'}`}>
      <input type="checkbox" 
      checked={todo.completed} 
      onChange={toggleCompleted} className='cursor-pointer ' />
